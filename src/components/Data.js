...
// Ag Grid
import { AgGridReact, AgGridColumn, gridOptions } from "ag-grid-react";
...
function Data(props) {
    ...
    let { volcanoLoading, volcanoes, volcanoError } = useVolcanoes(props.country, props.distanceForPop);
